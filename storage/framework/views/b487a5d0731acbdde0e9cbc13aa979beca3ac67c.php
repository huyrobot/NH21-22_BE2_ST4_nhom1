						...
						<ul class="main-menu">
							<li>
								...
								<ul class="sub-menu">
									...
									<li><a href="<?php echo e(asset('/home')); ?>">Homepage 2</a></li>
							...
							<li class="label1" data-label1="hot">
								<a href="<?php echo e(asset('/shoping-cart')); ?>">Features</a>
							</li>

							<li>
								<a href="<?php echo e(asset('/blog')); ?>">Blog</a>
							</li>
			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						<!-- item blog -->
						<div class="p-b-63">
							<a href="<?php echo e(asset('/blog-detail')); ?>" class="hov-img0 how-pos5-parent">
								<img src="<?php echo e(asset('images/blog-04.jpg')); ?>" alt="IMG-BLOG">
							...
							<div class="p-t-32">
								<h4 class="p-b-15">
									<a href="<?php echo e(asset('/blog-detail')); ?>" class="ltext-108 cl2 hov-cl1 trans-04">
								...
								<div class="flex-w flex-sb-m p-t-18">
									...
									<a href="<?php echo e(asset('/blog-detail')); ?>" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
										Continue Reading
						...
						<div class="p-b-63">
							<a href="<?php echo e(asset('/blog-detail')); ?>" class="hov-img0 how-pos5-parent">
								<img src="<?php echo e(asset('images/blog-05.jpg')); ?>" alt="IMG-BLOG">
						...
						<div class="p-b-63">
							<a href="<?php echo e(asset('/blog-detail')); ?>" class="hov-img0 how-pos5-parent">
								<img src="<?php echo e(asset('images/blog-06.jpg')); ?>" alt="IMG-BLOG">
							...
							<ul>
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="<?php echo e(asset('images/product-min-01.jpg')); ?>" alt="PRODUCT">
									</a>
								...
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="<?php echo e(asset('images/product-min-02.jpg')); ?>" alt="PRODUCT">
									</a>
								...
								<li class="flex-w flex-t p-b-30">
									<a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
										<img src="<?php echo e(asset('images/product-min-03.jpg')); ?>" alt="PRODUCT">
									</a>
...
</html><?php /**PATH C:\Users\LeTuan\NH21-22_BE2_ST4_nhom1\resources\views/blog.blade.php ENDPATH**/ ?>