...
<body class="animsition">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="hot">
								<a href="<?php echo e(asset('shoping-cart.html')); ?>">Features</a>
							</li>
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			...
			<a href="<?php echo e(asset('blog.html')); ?>" class="stext-109 cl8 hov-cl1 trans-04">
				Blog
				<i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
			</a>
...
</html><?php /**PATH C:\Users\LeTuan\NH21-22_BE2_ST4_nhom1\resources\views/blog-detail.blade.php ENDPATH**/ ?>