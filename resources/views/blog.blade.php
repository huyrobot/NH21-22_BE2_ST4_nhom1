				...
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						...
						@foreach($data1 as $value1)
							...
							<div class="p-t-32">
								<h4 class="p-b-15">
									<a href="{{ asset (url('/blog-detail/'.$value1->id)) }}" class="ltext-108 cl2 hov-cl1 trans-04">
									{{ $value1->title_blog}}
									</a>
								</h4>
								...
								<div class="flex-w flex-sb-m p-t-18">
									...
									<a href="{{ asset (url('/blog-detail/'.$value1->id)) }}" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
										Continue Reading
